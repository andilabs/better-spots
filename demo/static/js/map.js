...
(function() {
  var arrMarkers, calculateDistance, checkIfEmpty, checkIfNewSpotsShouldBeLoaded, check_cookies, currentMapCenter, currentZoomLevel, desiredRadius, filterSpots, filters_allowance, filters_types, hideAllInfoWindows, loadMarkers, my_map, opts, spot_type_lookup, switchColumsClasses,
    ...
    jqxhr = $.getJSON(url, function(data) {
      ...
      for (k in arrMarkers) {
        ...
        $("#map_canvas").gmap("addMarker", marker.marker).click(function() {
          var id;
          console.log("blah", this.id);
          console.log("blah", arrMarkers[this.id]);
  ...
  $("#map_canvas").on('click', function(e) {
    var new_position, user_zoom_level;
    ...
    return console.log("radius:", desiredRadius);
  });

  $("#map_canvas").on('click', 'div.rate', function(e) {
    console.log("spot: " + this.id);
    return console.log($(this).find('input[name="score"]').val());
  });
