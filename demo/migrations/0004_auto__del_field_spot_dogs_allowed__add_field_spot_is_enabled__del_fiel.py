...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Spot.dogs_allowed'
        db.delete_column(u'demo_spot', 'dogs_allowed')

        # Adding field 'Spot.is_enabled'
        db.add_column(u'demo_spot', 'is_enabled',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Raiting.dogs_allowed'
        db.delete_column(u'demo_raiting', 'dogs_allowed')

        # Adding field 'Raiting.is_enabled'
        db.add_column(u'demo_raiting', 'is_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Spot.dogs_allowed'
        db.add_column(u'demo_spot', 'dogs_allowed',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Spot.is_enabled'
        db.delete_column(u'demo_spot', 'is_enabled')

        # Adding field 'Raiting.dogs_allowed'
        db.add_column(u'demo_raiting', 'dogs_allowed',
                      self.gf('django.db.models.fields.BooleanField')(default=None),
                      keep_default=False)

        # Deleting field 'Raiting.is_enabled'
        db.delete_column(u'demo_raiting', 'is_enabled')
