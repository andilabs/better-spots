...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.post_slug'
        db.add_column(u'blog_post', 'post_slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=1000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.post_slug'
        db.delete_column(u'blog_post', 'post_slug')
    ...
    models = {
        ...
        u'blog.post': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post_slug': ('django.db.models.fields.SlugField', [], {'max_length': '1000'}),
