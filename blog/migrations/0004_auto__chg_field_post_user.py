...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_post', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.SpotUser'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'Post.user'
        db.alter_column(u'blog_post', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['accounts.SpotUser']))
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'spot': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'blog_posts'", 'null': 'True', 'to': u"orm['core.Spot']"}),
            'text': ('django.db.models.fields.TextField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.SpotUser']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'})
        },
