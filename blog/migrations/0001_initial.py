...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_post', (
            ...
            ('spot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Spot'], null=True)),
            ('blogpost_photo', self.gf(u'django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('cropping_blogpost_photo', self.gf(u'django.db.models.fields.CharField')(default=u'', max_length=255, blank=True)),
        ))
