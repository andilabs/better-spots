...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Opinion.raiting'
        db.delete_column(u'core_opinion', 'raiting_id')

        # Adding field 'Opinion.rating'
        db.add_column(u'core_opinion', 'rating',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['core.Raiting'], unique=True, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Opinion.raiting'
        raise RuntimeError("Cannot reverse this migration. 'Opinion.raiting' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Opinion.raiting'
        db.add_column(u'core_opinion', 'raiting',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Raiting'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'Opinion.rating'
        db.delete_column(u'core_opinion', 'rating_id')
    ...
    models = {
        ...
        u'core.opinion': {
            ...
            'rating': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['core.Raiting']", 'unique': 'True', 'primary_key': 'True'})
        },
