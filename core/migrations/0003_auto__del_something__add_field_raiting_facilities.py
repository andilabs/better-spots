...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'core_something')

        # Adding field 'Raiting.facilities'
        db.add_column(u'core_raiting', 'facilities',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'core_something', (
            ('data', self.gf(u'django_hstore.fields.DictionaryField')(default=None, null=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal(u'core', ['Something'])

        # Deleting field 'Raiting.facilities'
        db.delete_column(u'core_raiting', 'facilities')
