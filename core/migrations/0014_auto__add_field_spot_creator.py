...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Spot.creator'
        db.add_column(u'core_spot', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.SpotUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Spot.creator'
        db.delete_column(u'core_spot', 'creator_id')
