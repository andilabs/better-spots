...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spot.phone_number'
        db.alter_column(u'core_spot', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Spot.address_city'
        db.alter_column(u'core_spot', 'address_city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Spot.address_number'
        db.alter_column(u'core_spot', 'address_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Spot.address_street'
        db.alter_column(u'core_spot', 'address_street', self.gf('django.db.models.fields.CharField')(max_length=254, null=True))

        # Changing field 'Spot.address_country'
        db.alter_column(u'core_spot', 'address_country', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Spot.phone_number'
        db.alter_column(u'core_spot', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Spot.address_city'
        db.alter_column(u'core_spot', 'address_city', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Spot.address_number'
        db.alter_column(u'core_spot', 'address_number', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Spot.address_street'
        db.alter_column(u'core_spot', 'address_street', self.gf('django.db.models.fields.CharField')(max_length=254))

        # Changing field 'Spot.address_country'
        db.alter_column(u'core_spot', 'address_country', self.gf('django.db.models.fields.CharField')(max_length=100))
