...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Spot.anonymous_creator_cookie'
        db.add_column(u'core_spot', 'anonymous_creator_cookie',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Spot.anonymous_creator_cookie'
        db.delete_column(u'core_spot', 'anonymous_creator_cookie')
