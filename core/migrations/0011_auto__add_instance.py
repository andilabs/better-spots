...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_instance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=254, null=True, blank=True)),
            ('slogan', self.gf('django.db.models.fields.CharField')(default='', max_length=254, null=True, blank=True)),
            ('subject', self.gf('django.db.models.fields.CharField')(default='', max_length=254, null=True, blank=True)),
            ('main_color', self.gf('django.db.models.fields.CharField')(default='', max_length=254, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('windows_phone_store_url', self.gf('django.db.models.fields.URLField')(max_length=1023, null=True, blank=True)),
            ('google_store_url', self.gf('django.db.models.fields.URLField')(max_length=1023, null=True, blank=True)),
            ('apple_store_url', self.gf('django.db.models.fields.URLField')(max_length=1023, null=True, blank=True)),
        ))
        db.send_create_signal(u'core', ['Instance'])


    def backwards(self, orm):
        # Deleting model 'Instance'
        db.delete_table(u'core_instance')
