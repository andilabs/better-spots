...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Spot', fields ['name', 'address_street', 'address_number', 'address_city', 'address_country']
        db.create_unique(u'core_spot', ['name', 'address_street', 'address_number', 'address_city', 'address_country'])

        # Adding field 'Instance.instagram'
        db.add_column(u'core_instance', 'instagram',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Instance.facebook'
        db.add_column(u'core_instance', 'facebook',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Instance.twitter'
        db.add_column(u'core_instance', 'twitter',
                      self.gf('django.db.models.fields.CharField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Spot', fields ['name', 'address_street', 'address_number', 'address_city', 'address_country']
        db.delete_unique(u'core_spot', ['name', 'address_street', 'address_number', 'address_city', 'address_country'])

        # Deleting field 'Instance.instagram'
        db.delete_column(u'core_instance', 'instagram')

        # Deleting field 'Instance.facebook'
        db.delete_column(u'core_instance', 'facebook')

        # Deleting field 'Instance.twitter'
        db.delete_column(u'core_instance', 'twitter')
