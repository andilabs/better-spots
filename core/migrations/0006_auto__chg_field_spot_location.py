...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spot.location'
        db.alter_column(u'core_spot', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(default=None, max_length=40))

    def backwards(self, orm):

        # Changing field 'Spot.location'
        db.alter_column(u'core_spot', 'location', self.gf('django.contrib.gis.db.models.fields.PointField')(max_length=40, null=True))
