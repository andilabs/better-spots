...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Instance.bloger_photo'
        db.add_column(u'core_instance', 'bloger_photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Instance.bloger_photo'
        db.delete_column(u'core_instance', 'bloger_photo')
