...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'UsersSpotsList', fields ['user', 'spot', 'role']
        db.create_unique(u'core_usersspotslist', ['user_id', 'spot_id', 'role'])


    def backwards(self, orm):
        # Removing unique constraint on 'UsersSpotsList', fields ['user', 'spot', 'role']
        db.delete_unique(u'core_usersspotslist', ['user_id', 'spot_id', 'role'])
