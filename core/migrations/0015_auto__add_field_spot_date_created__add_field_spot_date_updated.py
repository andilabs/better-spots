...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Spot.date_created'
        db.add_column(u'core_spot', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Spot.date_updated'
        db.add_column(u'core_spot', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Spot.date_created'
        db.delete_column(u'core_spot', 'date_created')

        # Deleting field 'Spot.date_updated'
        db.delete_column(u'core_spot', 'date_updated')
    ...
    models = {
        ...
        u'core.spot': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounts.SpotUser']", 'null': 'True', 'blank': 'True'}),
